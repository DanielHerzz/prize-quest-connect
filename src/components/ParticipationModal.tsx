  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "سيتم توجيهك الآن إلى العرض. أكمل المهام المطلوبة للتأهل للسحب.",
      });
        ...
        <DialogHeader>
          <DialogTitle className="text-center">
            <div className="space-y-4">
              ...
              <h2 className="text-2xl font-bold text-white">المشاركة في السحب</h2>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20">
            <CardContent className="p-4 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-gray-300">المشاركات المتبقية:</span>
              ...
              <div className="flex items-center text-sm text-gray-400">
                ...
                <span>يتم إجراء السحب عند اكتمال العدد المطلوب</span>
              </div>
            </CardContent>
          </Card>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Card className="bg-blue-500/20 border-blue-500/30">
              <CardContent className="p-4">
                <h4 className="text-white font-medium mb-3">خطوات المشاركة:</h4>
          ...
          <div className="flex items-start space-x-3 p-4 bg-yellow-500/20 rounded-lg border border-yellow-500/30">
            ...
            <div className="text-sm">
              ...
              <p className="text-yellow-200">
                تأكد من إكمال جميع خطوات العرض للتأهل للسحب. ستتلقى تأكيدًا عبر البريد الإلكتروني عند نجاح مشاركتك.
              </p>
            </div>
          </div>
        </div>
